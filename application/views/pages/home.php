						...
						<div class="row align-items-center no-gutters w-100">
							...
							<div class="col-lg-4 offset-lg-2 col-md-4">
								<figure class="slider-image d-none d-md-block">
									<img src="web_minuman_cu/system/assets/Logo.jpg" alt="Logo Minuman Cu">
								</figure>
							</div>
						</div>
					</div>
					...
					<div class="featured-product">
						<div class="featured-product__inner info-center">
							<figure class="featured-product__image">
								<img src="dist/img/products/product-01-500x466.jpg" alt="Featured Product">
							</figure>
				...
				<div class="col-md-6">
					<div class="featured-product">
						<div class="featured-product__inner info-left-bottom">
							<figure class="featured-product__image">
								<img src="dist/img/products/product-02-500x575.jpg" alt="Featured Product">
							</figure>
					...
					<div class="limited-product__image">
						...
						<div class="limited-product__large-image">
							<div class="element-carousel main-slider" data-slick-options='{
								...
								<div class="item">
									<figure>
										<img src="dist/img/products/product-11-321x450.png"
											alt="Countdown Product">
									</figure>
								</div>
								<div class="item">
									<figure>
										<img src="dist/img/products/product-12-321x450.png"
											alt="Countdown Product">
									</figure>
								</div>
								<div class="item">
									<figure>
										<img src="dist/img/products/product-13-321x450.png"
											alt="Countdown Product">
									</figure>
								</div>
							</div>
						...
						<div class="limited-product__nav-image">
							...
							>
								<div class="item">
									<figure>
										<img src="dist/img/products/product-11-123x127.jpg"
											alt="Product Nav Image">
									</figure>
								</div>
								<div class="item">
									<figure>
										<img src="dist/img/products/product-12-123x127.jpg"
											alt="Product Nav Image">
									</figure>
								</div>
								<div class="item">
									<figure>
										<img src="dist/img/products/product-13-123x127.jpg"
											alt="Product Nav Image">
									</figure>
								</div>
							</div>
			...
			<div class="row align-items-center">
				<div class="col-md-6 mb-sm--50">
					<div class="featured-product">
						<div class="featured-product__inner info-right-bottom">
							<figure class="featured-product__image">
								<img src="dist/img/products/product-14-500x575.jpg" alt="Featured Product">
							</figure>
				...
				<div class="col-md-6">
					<div class="featured-product">
						<div class="featured-product__inner info-center">
							<figure class="featured-product__image">
								<img src="dist/img/products/product-15-500x466.jpg" alt="Featured Product">
							</figure>
